> **Legacy (March 2026).** Preserved for decision history only. Superseded by [docs/ZEUS_LINEAR_TICKET_PLAN.md](../../../docs/ZEUS_LINEAR_TICKET_PLAN.md) and [zeus/docs/roadmap.md](../roadmap.md). Sprint numbering, mem0, and the "Hermes/Apollo" naming here predate the final Greek naming convention (iris / orpheus / mnemosyne).
