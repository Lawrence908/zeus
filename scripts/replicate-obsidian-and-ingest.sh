...
#
# Environment:
#   ZEUS_ROOT           — repo root (default: current working directory)
#   OBSIDIAN_SYNC       — absolute path to sync-headless-vault.sh (required)
...
OBSIDIAN_SYNC="${OBSIDIAN_SYNC:?set OBSIDIAN_SYNC to the absolute path of sync-headless-vault.sh}"
